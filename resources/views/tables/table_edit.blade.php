...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit "{{$table->number}}" Table</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card shadow-lg">
              <div class="card-body">
                  <a href="/tables" class="btn btn-warning mb-3"><i class="fas fa-arrow-left mr-2"></i>Back</a>
                    <form action="{{route('tableupdate',$table->id)}}" method="POST" class="mx-auto w-50"  enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="">Table Name or Number</label>
                            <input type="text" name="tablename" class="form-control" value="{{$table->number}}">
                        </div>
                        <label for="customRange3" class="form-label">Level:</label>
                        <input type="range" class="form-control-range" min="1" max="3" step="1" id="" value="{{$level}}" name="tablelevel">
                        <small>Classic</small>
